 ...
 <div id="layoutSidenav">
     <div id="layoutSidenav_nav">
         <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
             <div class="sb-sidenav-menu leftMenuDiv">
                 <div class="nav">
                     ...
                     <div class="sb-sidenav-menu-heading">공통</div>
			...
			<!-- ---------------- 전자결재 ---------------->
             ...
             <!-- ---------------- 일반문서함 ---------------->
				...
				<!-- 중분류 -->				
                     ...
                     <div class="sb-sidenav-menu-heading">아파트관리</div>
 			 <!-- ---------------- 입주민관리 ---------------->
				<!-- 대분류 -->			
             ...
             <!-- ------------- 차량관리 ------------------->
                ...
                <!-- 중분류 -->
                     <div class="collapse" id="collapseCar" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                         <nav class="sb-sidenav-menu-nested nav">
                             <a class="nav-link" href="${pageContext.request.contextPath}/office/carO/wholeCarList.do">등록 차량 조회</a>
                             <a class="nav-link" href="${pageContext.request.contextPath}/office/carO/residentCarList.do">입주민 차량 관리</a>
                             <a class="nav-link" href="${pageContext.request.contextPath}/office/carO/guestCarList.do">방문 차량 관리</a>
                         </nav>
                     </div>
             ...
             <!-- ---------------- 일정관리 ---------------->
				...
				<!-- 중분류 -->				
                     <div class="collapse" id="collapseCalendar" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                         <nav class="sb-sidenav-menu-nested nav">
                             <a class="nav-link" href="${cPath}/office/construction/wholeCalendar.do">아파트 전체일정</a>
                         </nav>
                     </div>  
 			 ...
 			 <!-- ---------------- 검침관리 ---------------->
				...
				<!-- 중분류 -->                     
                     <div class="collapse" id="collapseMeter" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                         <nav class="sb-sidenav-menu-nested nav">
                             <a class="nav-link" href="${cPath}/office/meter/meterAllList.do">전체 검침 조회</a>
                             <a class="nav-link" href="${cPath}/office/meter/meterCommList.do">공동 검침 관리</a>
                             <a class="nav-link" href="${cPath}/office/meter/meterIndvList.do">세대 검침 관리</a>
                         </nav>
                     </div>
 			 ...
 			 <!-- ---------------- 수납관리 ---------------->
				...
				<!-- 중분류 -->                     
                     <div class="collapse" id="collapseCostPayment" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                         <nav class="sb-sidenav-menu-nested nav">
                             <a class="nav-link" href="${cPath}/office/receipt/receiptChart.do">수납 통계</a>
 			 ...
 			 <!-- ---------------- 인사/근태관리 ---------------->
				...
				<!-- 소분류 -->                             
                             <div class="collapse" id="employeeBox" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                 <nav class="sb-sidenav-menu-nested nav">
                                     <a class="nav-link" href="${pageContext.request.contextPath}/office/employee/employeeForm.do">인사기본정보 등록</a>
				...
				<!-- 소분류 -->                             
                             <div class="collapse" id="attendanceBox" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                 <nav class="sb-sidenav-menu-nested nav">
                                     <a class="nav-link" href="${pageContext.request.contextPath}/office/employee/offList.do">휴가일수 계산</a>
                                     <a class="nav-link" href="${pageContext.request.contextPath}/office/serviceWorkList.do">현장직원 근무표</a>
                                 </nav>
                             </div>
                         </nav>
                     </div>
  			 ...
  			 <!-- ---------------- 급여/정산관리 ---------------->
				...
				<!-- 소분류 -->                             
                             <div class="collapse" id="salaryBox" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                 <nav class="sb-sidenav-menu-nested nav">
                                     ...
                                     <a class="nav-link" href="${pageContext.request.contextPath}/office/payment/paymentForMonthList.do">급여계산</a>
				...
				<!-- 소분류 -->                             
                             <div class="collapse" id="severancePay" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                 <nav class="sb-sidenav-menu-nested nav">
                                     <a class="nav-link" href="${pageContext.request.contextPath}/office/payment/severanceView.do">퇴직정산</a>
                                 </nav>
                             </div>
                         </nav>
                     </div>                    
  			 ...
  			 <!-- ---------------- 사이트관리 ---------------->
				...
				<!-- 소분류 -->                             
                             <div class="collapse" id="boardBox" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                 <nav class="sb-sidenav-menu-nested nav">
                                     <a class="nav-link" href="${pageContext.request.contextPath}/office/officeNotice/officeNoticeList.do">공지사항</a>
                                     <a class="nav-link" href="${pageContext.request.contextPath}/office/website/boardList.do">자유게시판</a>
                                 </nav>
                             </div>
                <!-- 중분류 -->
                             <a class="nav-link" href="${pageContext.request.contextPath}/office/officeQna/officeQnaList.do">문의게시판관리</a>
                <!-- 중분류 -->
