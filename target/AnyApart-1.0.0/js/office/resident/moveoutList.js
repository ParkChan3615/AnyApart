				...
				if(receiptList.length>0){
					$(receiptList).each(function(idx, receipt){
						...
						tr.append(
								...
								,$("<td>").text(receipt.costYear)
										.addClass("text-center")
								,$("<td>").text(receipt.costMonth)
										.addClass("text-center")
								,$("<td>").text(numberWithCommas(receipt.costCommTotal))
										.addClass("text-center")
								,$("<td>").text(numberWithCommas(receipt.costIndvTotal))
										.addClass("text-center")
								,$("<td>").text(numberWithCommas(receipt.receiptCost))
										.addClass("text-center")
