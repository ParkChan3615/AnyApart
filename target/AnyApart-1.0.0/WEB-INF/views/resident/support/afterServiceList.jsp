...
<div id="btnDiv">
	...
	<input type="button" id="insertBtn" value="신청하기" class="btn btn-default btn-sm mb20">
</div>    
<table class="table">
	...
	<tbody id="listTbody">
		...
		<c:forEach items="${pagingVO.dataList }" var="asVO">
			<tr>
	 			...
	 			<td style="text-align: center;">${asVO.asCodeName }</td>
	 			<td style="padding-left: 40px;">${asVO.memNick }</td>
	 			<td>${asVO.asDate }</td>
	 			<td>
