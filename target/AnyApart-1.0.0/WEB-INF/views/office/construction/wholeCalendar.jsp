...
<br>
<h4><strong>&nbsp;&nbsp;&nbsp;아파트 일정</strong></h4><br>
<input type="button" class="btn btn-outline-primary btn-lg" id="insertBtn" value="일정등록">
<div id='calendar'></div>
<br>
<p>※ 수리일정, 리모델링 일정은 일정 삭제시 접수도 함께 취소됩니다. 취소된 내역은 공사/수선관리에서 확인하실 수 있습니다. 
<div id="body">
...
function makeModal(schdNo){
	rmdlViewModal.find(".modal-body").load("${cPath}/office/construction/remodellingCalendarView.do?schdNo="+schdNo, function(){
		rmdlViewModal.modal();
	});	
}
