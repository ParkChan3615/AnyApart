	...
	<div class="col-md-12" style="border-style: outset; border-radius: 8px;">
		...
		<div class="card-body">
			<div class="row">
				...
				<div class="col-md-9">
					<select name="startYear" class="custom-select col-md-2 searchSelect">
		      		...
		      		<span>년&nbsp;</span>
					<select name="startMonth" class="custom-select col-md-2 searchSelect">
						<option value>선택</option>
		      		...
		      		<span>월&nbsp;</span>&nbsp; ~ &nbsp;
					<select name="endYear" class="custom-select col-md-2 searchSelect">
						<option value>선택</option>
						<c:forEach begin="2010" end="2050" var="year">
		      		...
		      		<span>년&nbsp;</span>
					<select name="endMonth" class="custom-select col-md-2 searchSelect">
						<option value>선택</option>
						<c:forEach begin="1" end="12" var="month">
			...
			<div class="row">
				<div class="col-md-2">동/호 선택</div>
		      	<div class="col-md-9">
					<form:select path="pagingVO.searchDetail.startDong" name="startDong" onchange="makeHoOptions1(this.value)" cssClass="custom-select col-md-2 searchSelect">
						<form:option value="0000">선택</form:option>
						<form:options items="${dongList }" itemValue="dong" itemLabel="dong" />
					</form:select> 동&nbsp;
					<select name="startHo" id="startHo" class="custom-select col-md-2 searchSelect">
						<option value>선택</option>
					</select> 호&nbsp;&nbsp; ~ &nbsp;
					<form:select path="dongList" name="endDong" onchange="makeHoOptions2(this.value)" cssClass="custom-select col-md-2 searchSelect">
						<form:option value="0000">선택</form:option>
						<form:options items="${dongList }" itemValue="dong" itemLabel="dong"/>
					</form:select> 동&nbsp;
					<select name="endHo" id="endHo" class="custom-select col-md-2 searchSelect">
						<option value>선택</option>
					</select> 호 
				</div>
			</div><br>
