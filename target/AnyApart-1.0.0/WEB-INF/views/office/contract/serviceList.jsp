...
<div align="right" class="mb-2 mr-5">
	...
	<input type="button" class="btn btn-dark" role="alert" value="등록" onclick="location.href='${cPath}/office/servicecompany/serviceForm.do'">
	...
	<a  class="btn btn-primary" id="downExcelJxls" data-page='${pagingVO.currentPage }'>엑셀 다운로드</a>
</div>
			...
			<table class="table" id="listBody">
				...
				<tbody>
              	...
              	<c:if test="${not empty contractList }">
              		...
              		<tr id="trList" data-contract="${contract.svcId}" data-del="${contract.svcDel }">
              		<c:choose>
					<c:when test="${contract.svcDel eq 'Y' && contract.svcId ne 'SAMPLE'}">
	             		<td>${contract.svcRum } </td>
	              		<td>${contract.svcName } </td>
	              		<td>${contract.svcCode } </td>
	              		<td>${contract.svcDeposit }원 </td>
	...
	<div class="modal-dialog modal-fullscreen" data-bs-backdrop="static" >
	  <div class="modal-content">
	      ...
	      <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=20f2924230e0e2fb25bc546e44c0b498&libraries=services,clusterer,drawing&autoload=false"></script>
			...
			<input type="button" value="삭제" class="btn btn-primary mr-3" id="delectBtn" />
