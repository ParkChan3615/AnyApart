	...
	<table class="table table-bordered">
			...
			<tr>
				...
				<td colspan="3">
					<form id="searchForm" action="${cPath }/office/resident/moveoutFormAjax.do" method="get" class="form-inline">
						...
						<input type="text" name="dong" id="dong" required onkeypress="return onlyNumber(event)">&nbsp;동&nbsp;
						<input type="text" name="ho"  id="ho" required onkeypress="return onlyNumber(event)">&nbsp;호&nbsp;
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-center" colspan="3">
					<span class="reddot">* </span><span>1일~전출일까지의 검침량에 따른 관리비는 등록된 이메일로 별도 고지될 예정입니다.</span>
				</td>
			</tr>
			<tr>
...
<!-- 					<input data-command="insert" type="button" value="저장" class="btn btn-primary btn-command" id="insertBtn" /> -->
<!-- 					<input data-command="list" type="button" value="목록" class="btn btn-dark btn-command" id="listBtn" /> -->
					</form>
				</td>
			</tr>
		</tbody>
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="moveoutPayAuthModalLabel">관리자 인증</h3>
			</div>
