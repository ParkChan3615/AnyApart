...
<%-- 						</form:select> --%>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<input class="form-control-sm datetimepicker-input" type="date" name="resMoveoutStart" value="${param.resMoveoutStart }">
						&nbsp;~&nbsp;
						<input class="form-control-sm datetimepicker-input" type="date" name="resMoveoutEnd" value="${param.resMoveoutEnd }">
					</div>
					<div class="col-md-2">
