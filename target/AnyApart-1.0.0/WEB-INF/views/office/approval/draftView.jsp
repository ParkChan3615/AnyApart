...
<div class="container butDiv">
	<div class="float-right btnDiv container mr-5 mb-1">
	    <button class="btn alert-secondary float-right" id="listBtn">목록</button>
		  ...
		  <div class="card-body">
			 <form>
				 <table class="table table-bordered table-sm">
					  <tr>
					    <td width="20%">기안문서번호</td>
					    <td width="10%">${draft.draftId }</td>
					    <td width="10%">단위업무</td>
					    <td width="20%">${draft.taskCode}</td>
					    <td width="10%">기안일자</td>
					    <td width="30%">${draft.draftDate }</td>
					  </tr>
					  <tr>
					    <td>제목</td>
					  ...
					  <tr>
					  	<td>지출계좌</td>
					  	<td colspan='6'>${draft.draftAcct}</td>
					  </tr>
				</table>
				  <div>
					  <div class="mt-2" style="height:34em;overflow: auto">
					  	${draft.draftContent}
					  </div>
