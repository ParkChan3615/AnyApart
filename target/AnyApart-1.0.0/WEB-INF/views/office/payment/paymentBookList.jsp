...
<div class="container">
	<br>
	<h4><strong>급여지급대장</strong></h4>
	<br>
	
	
	<div class="d-flex justify-content-end">
	    <div class="d-flex justify-content-end"><button class="btn btn-dark" style='margin:5pt;'>검색</button></div>
	</div>
	...
	<input type="button" id="tmpBtn" value="연습" >
</form>
		  <table class="table table-bordered table-hover " id="tmpDiv">
			  ...
			  <c:set var="payList" value="${pagingVO.dataList }"/>
			    ...
			    <c:if test="${empty payList }">
			    	<tr>
			    		<td colspan="7">조회된 급여 지급 내역이 없습니다.</td>
			    	<tr>
			    </c:if>
			  </tbody>
		</table>
...
<script>
	...
	//연습=======================================
	let htmlVal = $("#tmpDiv").outerHTML(); $("#tmpDiv").clone().wrapAll("<div/>").parent().html();
