		    ...
		    <tbody>
			 ...
			 <div class="leftDiv col-sm-4" id="insertDiv">
			  <div class="form-inline mb-2">					  
			  	<input type="text" id="searchInput" name="searchInput" class="form-control" value="${pagingVO.searchDetail.employee.empName }" placeholder="사용자코드/성명/직책"> 
			  	<input type="button" value="검색" class="btn btn-primary ml-2" id="searchEmpBtn" >
			  	<input type="button" value="초기화" class="btn btn-primary ml-2" id="resetBtn">
			  </div>
				...
				<!-- 퇴직금 정산 규정 ----------------------------------------------------------------------------------------->
				<div id="lawTitleSpan">
					<span id="lawTitle" class="badge badge-secondary align-center">퇴직금 지급 기준</span>
				</div>
...
<script>
	...
	$("#sumSvrcBtn").on("click", function(){
		$.ajax({
			url:"${cPath }/office/payment/tmpSvrcView.do"
