...
<div class="container">
	...
	<div class="d-flex justify-content-center">
		<c:url value="/office/officeNotice/officeNoticeUpdate.do" var="updateURL">
			<c:param name="boNo" value="${board.boNo }"/>
		</c:url>
		<form id="updateForm" action="${cPath }/office/officeNotice/officeNoticeUpdate.do" method="GET">
		...
		<form id="deleteForm" action="${cPath }/office/officeNotice/officeNoticeDelete.do" method="POST">
			<input type="hidden" class="form-control" name="boNo" value="${board.boNo }"/>
		...
		<form id="listForm" action="${cPath }/office/officeNotice/officeNoticeList.do" method="GET">
			<input type="hidden" class="form-control" name="page" value="${param.page }"/>
			<input type="hidden" class="form-control" name="searchType" value="${param.searchType }"/>
			<input type="hidden" class="form-control" name="searchWord" value="${param.searchWord }"/>
