...
<div class="container">
	...
	<div class="d-flex justify-content-end">
   		 <div class="d-flex justify-content-end">
   		 <button onclick = "location.href = '${pageContext.request.contextPath}/office/officeNotice/officeNoticeForm.do'" class="btn btn-dark" style='margin:5pt;'>등록</button></div>
	</div>
	
	
	<form id="viewForm" method="get" action="${cPath }/office/officeNoticeView.do">
