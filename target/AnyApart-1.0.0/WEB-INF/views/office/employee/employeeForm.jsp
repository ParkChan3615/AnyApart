					...
					<div class="row mb-3">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="empAcct"
								name="empAcct" value="${employee.empAcct}" required onkeypress="return onlyAcct(event)" 
			...
			<c:if test="${not empty employee.empBank }">	
				<div>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="empName"
								name="empName" value="${employee.empName}" required maxlength="60">
					...
					<div class="row mb-3">
						...
						<div class="col-sm-4">
							<input type="date" class="form-control" id="empBirth"
								name="empBirth" value="${employee.empBirth}" required>
						</div>
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="empMail"
								name="empMail" value="${employee.empMail}" placeholder="이메일 형식 입력 (예:aa892@naver.com)" 
					...
					<div class="row mb-3">
						...
						<div class="col-sm-4">
							<input type="date" class="form-control" id="empStart" name="empStart" value="${employee.empStart}" required>
						</div>
					</div>
					<div class="row mb-3">
						<label for="empHp" class="col-sm-2 col-form-label"><span class="reddot">* </span>핸드폰번호</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="empHp" name="empHp" value="${employee.empHp}" required maxlength="11" 
							onkeypress="return onlyNumber(event)" placeholder="예) 01012345678">
						</div>
						<label for="empTel" class="col-sm-2 col-form-label"><span class="reddot">* </span>자택번호</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="empTel" name="empTel" value="${employee.empTel}" required maxlength="11" 
							onkeypress="return onlyNumber(event)" placeholder="예) 0541234567">
						</div>
					</div>
					<div class="row mb-3">
						<label for="empZip" class="col-sm-2 col-form-label"><span class="reddot">* </span>우편번호</label>
						<div class="col-sm-2">
							<input type="text" class="form-control" id="empZip" name="empZip" value="${employee.empZip}" required maxlength="5">
						</div>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="empAdd1"
								name="empAdd1" value="${employee.empAdd1}" required maxlength="60">
						</div>
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="empAdd2"
								name="empAdd2" value="${employee.empAdd2}" required maxlength="60">
						</div>
					</div>
					<div class="row mb-3">
