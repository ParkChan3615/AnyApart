...
<div align="right" class="mb-2 mr-5">
	<input type="button" class="btn btn-dark" role="alert" onclick="location.href='${cPath}/office/account/accountForm.do'" value="등록">
	<input type="button" class="btn btn-dark" role="alert" value="수정" onclick="cheakboxCK()">
