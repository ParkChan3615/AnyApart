	...
	<form id="loginForm" action="${pageContext.request.contextPath }/login/loginProcess.do" method="post">
		  <div class="tds-form-item">
                ...
                <div class="tds-tooltip">
                  ...
                  <div class="tds-tooltip-content">
                    ...
                    <p data-i18n-key="login:formIdentityTooltipText2" data-i18n-data="{&#34;link&#34;:{&#34;start&#34;:&#34;&lt;a href=\&#34;https://www.tesla.com/support/account-support\&#34; target=\&#34;_blank\&#34;&gt;&#34;,&#34;end&#34;:&#34;&lt;/a&gt;&#34;}}">
                		 관리사무소 직원과 입주민 회원들은 자신의 아이디를 입력하면 페이지가 이동합니다.
                    </p>
                  </div>
                </div> <!-- tds-tooltip -->
              </label>
              ...
              <div class="tds-text-input--wrapper" data-field="identity">
                <input type="text" id="form-input-identity" name="memId" value="${cookie.idCookie.value }" required class="tds-text-input" autocomplete="username" maxlength="11"/>
              ...
              <label class="tds-form-item-label" for="password-input">
               ...
               <div class="tds-text-input--wrapper" data-field="password">
                ...
                pattern="^(?=.*[0-9]+)(?=.*[a-zA-Z]+).{5,12}$" required/>
		...
		<button type="submit" class="tds-btn tds-btn--blue tds-btn--full" id="form-submit-continue">
            ...
            <p class="need-help tds-text--center">
              <a class="tds-link" href="${cPath }/login/findId"
              	 onClick="window.open(this.href, '', 'width=400, height=400'); return false;">아이디 찾기</a>
              <span class="tmp-link-separator">|</span>
              
              <a class="tds-link" href="${cPath }/login/findPass"
              	 onClick="window.open(this.href, '', 'width=400, height=400'); return false;">비밀번호 찾기</a>
            </p>
	</form>
	<div class="loginSelector">
		<button data-memid='ADMIN' data-mempass='aA123' class="tds-btn tds-btn--blue autoLogin" id="vendor-login">벤더 관리자</button>
		<button data-memid='A0001E007' data-mempass='aA123' class="tds-btn tds-btn--blue autoLogin" id="head-login">소장 로그인</button>
		<button data-memid='A0001E002' data-mempass='aA123' class="tds-btn tds-btn--blue autoLogin" id="emp-login">사원 로그인</button>
		<button data-memid='A0001R00001' data-mempass='aA123' class="tds-btn tds-btn--blue autoLogin" id="res-login">입주민 로그인</button>
	</div>
</div>
</main>
