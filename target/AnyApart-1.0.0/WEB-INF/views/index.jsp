        ...
        <div id="head">
            ...
            <div id="gnb">
                <ul id="menu">
                    ...
                    <li data-menuanchor="page3"><a href="#">기능소개</a></li>
...
<%--                     	<li data-menuanchor="page3"><a href="#" class="link-success" onclick="clickHandler(event);" data-href="${pageContext.request.contextPath }/login/logout.do">로그아웃</a></li> --%>
                    </security:authorize>
