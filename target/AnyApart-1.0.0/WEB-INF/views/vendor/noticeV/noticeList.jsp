    ...
    <div id="container">
        <div class="inner">
            ...
            <div class="board-list">
                <div align="right">
					<input class="btn" type="button" value="공지글 작성" onclick="location.href='${cPath }/vendor/noticeForm.do'">
				</div>
                <table>
                    <colgroup>
...
<%-- 	                   				<td>[AnyApart]<br>${board.boWriter }</td> --%>
	                   				...
	                   				<input class="btn btn-blue" type="button" value="공지글 수정" onclick="location.href='${updateURL}'">
							        ...
							        <input class="btn btn-red" type="submit" value="공지글 삭제">
							        </form>
          					 	</td>
          					 	</tr>
                    		</c:forEach>
