...
<script>
let listBody = $("#listBody").on("dblclick", 'tr', function(){
	let trAptCode = $(this).data('aptcode');
	location.href='${cPath }/vender/apartView.do?aptCode='+trAptCode+"&page=${pagingVO.currentPage }&searchType=${pagingVO.searchVO.searchType }&searchWord=${pagingVO.searchVO.searchWord }";
});
...
insertBtn.on("click", function(){
	location.href="<c:url value='/vender/apartForm.do'/>";
});
