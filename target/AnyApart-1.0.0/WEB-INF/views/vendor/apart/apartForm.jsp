...
<div id="container">
    <div class="inner">
        ...
        <div class="board-list">
            <form:form commandName="apart" action="${cPath }/vender/apartInsert.do" id="apartForm" method="post" enctype="multipart/form-data">
	            <table>
	            	<colgroup>
...
<!-- 								<input type="text" id="sample4_extraAddress" placeholder="참고항목"> -->
		        ...
		        <div align="right">
					<input class="btn btn-dark" id="insertBtn" type="submit" value="아파트 등록">
				</div>
            </form:form>
        </div>
    </div>
		...
		$(resp.option).each(function(idx, opt){
			opts.push(
				...
				$("<option>").text(opt.codeName)
							 ...
							 .prop("selected", "${pagingVO.searchDetail.aptHeat}"==opt.codeId)
